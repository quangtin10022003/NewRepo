...
(
  IdDetailForm INT IDENTITY(1,1) NOT NULL,
  Quantity INT NOT NULL,
  IdForm INT NOT NULL,
  IdPriceList INT NOT NULL,
  IsPay BIT,
  PRIMARY KEY (IdDetailForm),
...
(
  ...
  IdDetailForm INT NOT NULL,
  PRIMARY KEY CLUSTERED (IdDSL ASC),
  FOREIGN KEY (IdDetailForm) REFERENCES DetailForm(IdDetailForm)
);
...
(N'Lê Lâm Chí Dĩnh','0987123123'),
(N'Lê Trần Quang Tín','0987333456'),
...
(N'Kiểm tra sứuc khỏe nâng cao - Advanced checkup',1500000,1),
...
INSERT INTO Form (ExamDate, IdDoctor, IdCus,  IdStaff) VALUES
('2023-07-23', 1, 1, 1), 
('2023-08-15', 2, 2, 2),
('2023-08-18', 3, 3, 3),
('2023-09-01', 1, 4, 4), 
...
INSERT INTO DetailForm (Quantity, IdForm, IdPriceList, IsPay) VALUES
(1, 1, 1, 0), 
(1, 2, 4, 0),
(2, 3, 5, 0),
(3, 4, 6, 1), 
...
INSERT INTO DiseaseStatisticList (Dianose, IdDetailForm) VALUES
...
BEGIN
  ...
  SET IsPay = 0
  FROM inserted
  WHERE DetailForm.IdDetailForm = inserted.IdDetailForm;
END;
