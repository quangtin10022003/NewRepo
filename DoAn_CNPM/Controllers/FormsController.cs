...
namespace DoAn_CNPM.Models
{
    public class FormsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdForm,ExamDate,IdDoctor,IdCus,IdStaff")] Form form)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdForm,ExamDate,IdDoctor,IdCus,IdStaff")] Form form)
        {
            if (ModelState.IsValid)
            {
